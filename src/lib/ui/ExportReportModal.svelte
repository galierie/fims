<script lang="ts">
    ...
    const hasFacultyReports = $derived(
        exportProfile || exportServiceRecord || exportLoading || exportSetAvg,
    );
    ...
    const selectedDownloads = $derived.by(() => {
        ...
        if (hasFacultyReports) {
            ...
            if (aggregateFaculty) {
                ...
                const fileName = isOnlyProfile
                    ? 'Aggregated_Faculty_Profiles'
                    : `Aggregated_Faculty_Reports${rangeSuffix}`;
                links.push({
                    name: fileName,
                ...
                for (const faculty of selectedFaculty) {
                    const fileName = isOnlyProfile
                        ? `${faculty.lastname}_Faculty_Profile`
                        : `${faculty.lastname}_Reports${rangeSuffix}`;
                    links.push({
                        name: fileName,
...
<div
    class="fixed top-0 left-0 z-100 flex h-full w-full items-center justify-center bg-black/40 p-4 backdrop-blur-sm transition-opacity"
>
    <div
        class="max-h-[95vh] w-[90%] max-w-3xl overflow-y-auto rounded-2xl bg-fims-beige px-10 py-10 shadow-xl"
    >
        ...
        {#if step === 1}
            <p class="mb-8 text-base text-black">
                Please select the options for the reports you wish to export.
            </p>
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative w-64">
                            <select
                                bind:value={startAy}
                                class="w-full appearance-none rounded-xl border border-fims-green bg-white px-4 py-2.5 text-black outline-none focus:ring-1 focus:ring-fims-green {startAy ===
                                ''
                                    ? 'text-gray-500'
                                    : ''}"
                            >
                            ...
                            <Icon
                                ...
                                class="pointer-events-none absolute top-3.5 right-3 h-5 w-5 text-fims-green"
                            />
                        </div>
                        <div class="relative w-56">
                            <select
                                bind:value={startSem}
                                class="w-full appearance-none rounded-xl border border-fims-green bg-white px-4 py-2.5 text-black outline-none focus:ring-1 focus:ring-fims-green {startSem ===
                                ''
                                    ? 'text-gray-500'
                                    : ''}"
                            >
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative w-64">
                            <select
                                bind:value={endAy}
                                class="w-full appearance-none rounded-xl border border-fims-green bg-white px-4 py-2.5 text-black outline-none focus:ring-1 focus:ring-fims-green {endAy ===
                                ''
                                    ? 'text-gray-500'
                                    : ''}"
                            >
                        ...
                        <div class="relative w-56">
                            <select
                                bind:value={endSem}
                                class="w-full appearance-none rounded-xl border border-fims-green bg-white px-4 py-2.5 text-black outline-none focus:ring-1 focus:ring-fims-green {endSem ===
                                ''
                                    ? 'text-gray-500'
                                    : ''}"
                            >
                                ...
                                {#each semesters as sem}
                                    <option
                                        ...
                                        disabled={startAy !== '' &&
                                            endAy === startAy &&
                                            startSem !== '' &&
                                            sem.id < startSem}>{sem.name}</option
                                    >
                                {/each}
                            </select>
                            <Icon
                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-3 pl-2">
                            <label class="flex cursor-pointer items-start gap-3"
                                ...
                                /><span class="text-base text-black">Faculty Profile</span></label
                            >
                            <label class="flex cursor-pointer items-start gap-3"
                                ><input
                                    type="checkbox"
                            ...
                            <label class="flex cursor-pointer items-start gap-3"
                                ><input
                                    ...
                                    class="mt-0.5 h-5 w-5 rounded border-fims-green text-fims-green focus:ring-fims-green"
                                /><span class="text-base text-black">Faculty Loading</span></label
                            >
                            <label class="flex cursor-pointer items-start gap-3"
                                ><input
                                    type="checkbox"
                            ...
                            <label class="flex cursor-pointer items-start gap-3"
                                ><input
                                    type="checkbox"
                                    bind:checked={aggregateFaculty}
                                    class="mt-0.5 h-5 w-5 rounded border-fims-green text-fims-green focus:ring-fims-green"
                                /><span class="text-base font-semibold text-fims-green"
                                    >Aggregate Selected Reports into One File?</span
                                ></label
                            >
                        </div>
                    </div>
                            ...
                            <div class="flex flex-col gap-3 pl-2">
                                <label class="flex cursor-pointer items-start gap-3"
                                    ...
                                    /><span class="text-base text-black"
                                        >By Faculty, Subject Taught</span
                                    ></label
                                >
                                <label class="flex cursor-pointer items-start gap-3"
                                    ><input
                                        ...
                                        class="mt-0.5 h-5 w-5 rounded border-fims-green text-fims-green focus:ring-fims-green"
                                    /><span class="text-base text-black"
                                        >By Subject Taught, Faculty</span
                                    ></label
                                >
                            ...
                            <div class="flex flex-col gap-3 pl-2">
                                <label class="flex cursor-pointer items-center gap-3"
                                    ><input
                                        ...
                                        value="csv"
                                        bind:group={format}
                                        class="h-5 w-5 border-fims-green text-fims-green focus:ring-fims-green"
                                    /><span class="text-base text-black">CSV</span></label
                                >
                                <label class="flex cursor-pointer items-center gap-3"
                                    ><input
                                        type="radio"
                                        ...
                                        bind:group={format}
                                        class="h-5 w-5 border-fims-green text-fims-green focus:ring-fims-green"
                                    /><span class="text-base text-black">XLSX</span></label
                                >
                            </div>
                        </div>
                    </div>
                ...
                {#each selectedDownloads as download}
                    ...
                    >
                        ...
                        <a
                            ...
                            class="ml-4 flex shrink-0 items-center gap-2 font-semibold text-fims-green transition-opacity hover:opacity-70"
                        >
